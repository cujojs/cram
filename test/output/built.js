...
define("text!js/templates/snippet.html", function () {
 ...
 *      define("css", ['css!some/folder/file'], {}); // wait for some/folder/file.css
		...
		'build': function (writer, fetcher, config) {
			...
			return function write (pluginId, resource, resolver) {
				...
				if (!(absId in built)) {
					...
					// TODO: fix parser so that it doesn't choke on the word define("css",  in a string
...
define("css!js/tiny.css", ["css!"], function (api) {
	var cssText = ".tiny {\n\tcolor: blue;\n\tbackground-color: yellow;\n}\n";
	cssText = api.translateUrls(cssText, "js/tiny.css");
	return api.proxySheet(api.injectStyle(cssText));
});
define("js/moduleWithPluginDeps", ['text!./templates/snippet.html', 'css!./tiny.css'], function (snippet) {
