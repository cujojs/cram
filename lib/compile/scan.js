...
define([], function () {
	...
	// *****
	// TODO: do two passes! First pass can replace comments and regexps with spaces.
	// *****
	...
	findDefinesRx = new RegExp(
		...
		// escaped quotes are captured, too
		+ '|(\\\\["\'])|(["\'])'
	...
	function scan (source) {
		...
		function amdParser (m, rval, def, id, deps, factory, args, fStart, bcStart, bcEnd, lcStart, lcEnd, rx, escQ, q, pStart, pEnd, matchPos) {
console.log(m, inString, inComment, m.charCodeAt(0));
